...
func newCmdAdd(name, fullName string) *cobra.Command {
	...
	cmd.Flags().StringVar(&o.WebhookSecret, "webhook-secret", "", "Provide a secret that we can use to authenticate incoming hooks from your Git hosting service for Service repository. (if not provided, it will be auto-generated)")
