...
// 				CICDEnv: &config.Cicd{Namespace: "cicd"},
// 			},
// 		},
// 	}
...
func buildManifest(withCICD, withArgoCD string) *config.Manifest {

	// special = nil
	// if withCICD != "" && withArgoCD != "" {
	// 	cicdEnv := &config.Cicd{Namespace: withCICD}
	// 	argocd := &config.Argo{Namespace: withArgoCD}
